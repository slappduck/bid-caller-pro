...
# The contact address must resolve to something a real person can act on.
# This once advertised support@curbcallpro.com when the domain had no MX
# record at all, so anyone who tried to reach us got a bounce -- worse than
# giving no address, because it reads as hiding. The mailbox exists now
# (Cloudflare Email Routing, verified 2026-08-26), so it is back.
